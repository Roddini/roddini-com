...
type ProjectForm = { name: string; company: string; year: string; description: string; tags: string; sort_order: number }
const emptyForm: ProjectForm = { name: '', company: '', year: '', description: '', tags: '', sort_order: 0 }
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-2">
        ...
        {items.length === 0 && <p className="text-white/30 text-sm">No projects yet.</p>}
      </div>
    </>
  )
}
