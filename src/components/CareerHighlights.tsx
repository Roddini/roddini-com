            ...
            {virtualCards.map(({ virtualIdx, offset, item }) => (
              ...
              >
                ...
                >
                  ...
                  <span
                    className="text-[10px] tracking-widest uppercase font-light mb-3"
                  ...
                  {item.link && (
                    <a
                      ...
                      className="mt-3 text-[10px] tracking-widest uppercase flex items-center gap-1.5 hover:opacity-100 transition-opacity duration-200"
